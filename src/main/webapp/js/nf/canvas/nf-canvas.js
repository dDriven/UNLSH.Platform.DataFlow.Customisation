...
(function (root, factory) {
    ...
    var DEFAULT_PAGE_TITLE = 'UNLSH PLATFORM';
    ...
    var reloadProcessGroup = function (processGroupId, options) {
        ...
        return $.ajax({
            ...
            if(DEFAULT_PAGE_TITLE == ''){
                DEFAULT_PAGE_TITLE = 'UNLSH Platform';
            }
            if(DEFAULT_PAGE_TITLE == null){
                DEFAULT_PAGE_TITLE = 'UNLSH Platform';
            }
            if(DEFAULT_PAGE_TITLE=='NiFi'){
                DEFAULT_PAGE_TITLE='UNLSH Platform'
            }

            if(rootBreadcrumb.permissions.canRead){
                document.title = 'UNLSH Platform';
            } else {
                document.title = 'UNLSH Platform';
            }
