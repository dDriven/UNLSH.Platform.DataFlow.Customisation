        ...
        var processGroup = $.Deferred(function (deferred) {
            $.ajax({
                ...
                if (response.permissions.canWrite) {
                    if(processGroup.name=='NiFi Flow') {

                        $('#process-group-name').removeClass('unset').val('UNLSH DataFlow');
                    }else{
                   ...
                   // $('#process-group-name').removeClass('unset').val(processGroup.name);
                    ...
                    if(processGroup.name=='NiFi Flow') {
                        // populate the header
                        $('#process-group-configuration-header-text').text('UNLSH DataFlow' + ' Configuration');
                    }else{
