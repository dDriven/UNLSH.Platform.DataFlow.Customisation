...
if(document.title=='NiFi History'){
    document.title='UNLSH History'
}
...
(function (root, factory) {
    ...
    var config = {
        ...
        nifiInstanceLabel: 'UNLSH PLATFORM',
        type: {
            processor: 'Processor',
    ...
    var updateChart = function () {
        ...
        if (statusHistoryDialog.is(':visible')) {
            ...
            var clusterDetailsContainer = buildDetailsContainer('UNLSH PLATFORM');
